      ...
      >
        ...
        <div className="w-full md:w-2/5 flex flex-col items-start">
          ...
          <textarea
            ...
            className="w-full h-48 text-sm py-2 px-4 rounded outline-none bg-transparent border-[1px] border-gray-400 transform transition-all duration-300 hover:scale-105 hover:shadow-md"
          ></textarea>
          <button
            onClick={notify}
            className="bg-emerald-500 py-3 hover:bg-emerald-600 px-5 rounded text-sm mt-4 w-full transform transition-all duration-300 hover:scale-105 hover:shadow-lg"
          >
            Create Task
          </button>
          <ToastContainer
            className="text-sm max-w-xs mx-2" 
            toastClassName="bg-purple-800 text-blue shadow-md rounded-lg px-4 py-2 mb-4" 
